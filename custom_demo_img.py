...
img_folder =  os.path.join(root_path, 'tools', 'img','OriginalImage')
...
c1 = [255,255,255]      # Contain 
c2 = [255,255,255]    # Cut
c3 = [255,255,255]  # Display
c4 = [255,255,255]    # Engine
c5 = [0,0,0]   # Grasp
c6 = [255,255,255]    # hit
c7 = [255,255,255]   # Pound
c8 = [255,255,255]    # support
c9 = [255,255,255]    # w-grasp
c10 = [184,0,141] 
c11 = [184,134,0] 
c12 = [184,134,223]
...
def visualize_mask(im, rois_final, rois_class_score, rois_class_ind, masks, ori_height, ori_width, im_name, thresh):
    ...
    for i in xrange(0, num_boxes):
        ...
        if cfg.TEST.MASK_REG:
            ...
            cv2.imwrite(im_name +'mask'+str(i)+'.jpg', color_curr_mask)
    ...
    cv2.imwrite(im_name+'obj_detction.jpg', img_out)
    cv2.waitKey(0)
